...
class General : public Product
{
private:
    std::string generalType;

public:
    General(std::string name, std::string desc, double price, int qty,
            std::string generalType, std::string seller = "")
        : Product(name, desc, price, qty, seller), generalType(generalType) {}

    std::string getType() const override { return generalType; }
    void display() const override;
    void save(std::ofstream &ofs) const override;
...
public:
    ...
    bool createGeneral(User *currentUser, const std::string &name, const std::string &desc,
                       double price, int qty, const std::string &generalType);
